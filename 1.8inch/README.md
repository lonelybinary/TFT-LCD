...
### Basic Information
- **Display Size**: 1.8 inch (1.77 inch)
- **Specification**: T177BH-C12-12
- **Driver IC**: ST7735S
...
### Physical Parameters
- **Active Display Area**: 128 x 160 pixels
- **Pixel Size**: Approximately 0.22mm x 0.22mm
- **Screen Size**: Approximately 28.16mm x 35.2mm
...
├── code/
│   └── 1.8inch_Test/
│       └── 1.8inch_Test.ino  # Arduino IDE version program
...
4. **Open Program**
   - Open `code/1.8inch_Test/1.8inch_Test.ino`
...
- **Check initialization**: Confirm resolution is set correctly (128x160)
