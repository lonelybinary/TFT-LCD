...
- **Pixel Size**: Approximately 0.17mm x 0.17mm
- **Screen Size**: Approximately 40.8mm x 54.4mm
...
├── code/
│   └── 2.0inch_Test/
│       └── 2.0inch_Test.ino  # Arduino IDE version program
...
4. **Open Program**
   - Open `code/2.0inch_Test/2.0inch_Test.ino`
