 ...
 * Resolution: 320x480 (Portrait native), can be changed to 480x320 via setRotation()
 * 
...
// ST7796 (Compatible with ST7365) native resolution: 320x480
// Note: GFX Library 1.6.4 API - Hardware SPI with MISO parameter
Arduino_DataBus *bus = new Arduino_ESP32SPI(TFT_DC, TFT_CS, TFT_SCLK, TFT_MOSI, GFX_NOT_DEFINED, 1 /* VSPI */, true /* use_psram */);
