...
void testText() {
  ...
  gfx->setTextSize(1);
  gfx->println("RESOLUTION:240x320");
  gfx->println("DRIVER IC:ST7789");
...
void setup() {
  ...
  Serial.println("驱动芯片: ST7789");
  Serial.println("屏幕尺寸: 2.0 英寸");
  Serial.println("分辨率: 240x320");
  ...
  // ST7789 初始化
  Serial.println("初始化 ST7789 屏幕 (240x320)...");
