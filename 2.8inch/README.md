# 2.8 Inch TFT-LCD Display Driver

## Photos

**Front**
![2.8 inch front](./images/2.8front.png)

**Back**
![2.8 inch back](./images/2.8back.png)
...
- **Pixel Size**: Approximately 0.24mm x 0.24mm
- **Screen Size**: Approximately 57.6mm x 76.8mm
...
├── code/
│   └── 2.8inch_Test/
│       └── 2.8inch_Test.ino  # Arduino IDE version program
...
4. **Open Program**
   - Open `code/2.8inch_Test/2.8inch_Test.ino`
