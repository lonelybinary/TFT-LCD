# MicroPython test — 2.4 inch (ST7789)
...
| `main.py` | this folder | The test script for the 2.4 inch |
...
└── tft-lcd/2.4inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `tft-lcd/2.4inch/code/micropython/main.py`
...
- **Display:** 2.4 inch, 240x320 pixels
