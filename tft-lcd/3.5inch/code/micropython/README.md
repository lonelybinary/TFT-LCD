# MicroPython test — 3.5 inch (ST7796)
...
| `main.py` | this folder | The test script for the 3.5 inch |
...
└── tft-lcd/3.5inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `tft-lcd/3.5inch/code/micropython/main.py`
...
- **Driver IC:** ST7796 (uses the `st77xx.py` driver)
