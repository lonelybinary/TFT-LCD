...
- **Driver chip:** ST7796
- **Resolution:** 320 × 480 pixels (portrait). Rotate it and you get 480 × 320 (landscape).
...
- **Screen size:** about 57.6mm × 86.4mm
...
This screen starts in portrait (320 × 480). To use it sideways in landscape (480 × 320), call `setRotation()` in your sketch. Rotations 0 and 2 are portrait; rotations 1 and 3 are landscape.
...
1. Open `code/3.5inch_Test/3.5inch_Test.ino` in the Arduino IDE.
