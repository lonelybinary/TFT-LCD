# MicroPython test — 2.8 inch (ST7789)
...
| `main.py` | this folder | The test script for the 2.8 inch |
...
└── tft-lcd/2.8inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `tft-lcd/2.8inch/code/micropython/main.py`
