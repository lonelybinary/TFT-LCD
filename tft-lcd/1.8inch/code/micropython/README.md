# MicroPython test — 1.8 inch (ST7735S)
...
| `main.py` | this folder | The test script for the 1.8 inch |
...
└── tft-lcd/1.8inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `tft-lcd/1.8inch/code/micropython/main.py`
...
- **Driver IC:** ST7735S (uses the `st77xx.py` driver)
