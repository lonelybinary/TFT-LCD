...
A 1.8-inch color display for your ESP32 projects. This page covers the specs and wiring for this size. For full setup steps, see the [TFT-LCD series README](../README.md).
...
- **Screen size:** about 28.2mm × 35.2mm
...
1. Open `code/1.8inch_Test/1.8inch_Test.ino` in the Arduino IDE.
