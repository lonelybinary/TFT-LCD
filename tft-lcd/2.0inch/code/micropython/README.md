# MicroPython test — 2.0 inch (ST7789)
...
| `main.py` | this folder | The test script for the 2.0 inch |
...
└── tft-lcd/2.0inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `tft-lcd/2.0inch/code/micropython/main.py`
...
mpremote cp tft-lcd/2.0inch/code/micropython/main.py :
mpremote reset
```

## Display details

- **Display:** 2.0 inch, 240x320 pixels
