...
A 2.0-inch IPS color display for your ESP32 projects. This page covers the specs and wiring for this size. For full setup steps, see the [TFT-LCD series README](../README.md).
...
- **Screen size:** about 40.8mm × 54.4mm
...
1. Open `code/2.0inch_Test/2.0inch_Test.ino` in the Arduino IDE.
