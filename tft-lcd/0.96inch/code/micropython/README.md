# MicroPython test — 0.96 inch (ST7735S)
...
| `main.py` | this folder | The test script for the 0.96 inch |
...
└── tft-lcd/0.96inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `tft-lcd/0.96inch/code/micropython/main.py`
