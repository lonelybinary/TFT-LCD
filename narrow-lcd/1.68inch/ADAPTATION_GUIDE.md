# 1.68-inch Display Adaptation Guide

This guide provides detailed instructions on how to adapt 3.5-inch tutorial code to the
1.68-inch display of the Narrow TFT LCD Collection.

## Display Specifications

| Parameter | Value | Description |
|-----------|-------|-------------|
| **Display Size** | 1.68 inch | Narrow TFT LCD Collection |
...
- **1.68-inch**: rotation **1**, landscape, 428 x 142
...
- **1.68-inch**: 428 x 142 pixels (landscape)
...
- **1.68-inch**: On/Off (Active **Low**), `digitalWrite(TFT_BACKLIGHT, LOW)`=ON

### 4. Offset Difference
- **3.5-inch**: Offset `0, 0, 0, 0`
- **1.68-inch**: Offset `12, 0, 14, 0`
...
| Text size | Pixel height | Characters across 428 px | Suitable for 1.68 inch? |
|-----------|--------------|--------------------------|---------------------------|
| 1 | 8 | 71 | yes |
| 2 | 16 | 35 | yes |
| 3 | 24 | 23 | yes |
