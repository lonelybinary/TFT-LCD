...
def display_lonely_binary(tft):
    ...
    tft.text("1.68inch", 4, info_y + 20, st77xx.WHITE)
...
# 8 MHz is the clock this panel was tested at with the Arduino sketch.
...
#
# NV3007_168 carries the 1.68 inch vendor init table (voltages, gamma).
tft = nv3007.NV3007_168(spi, dc=Pin(TFT_DC), cs=Pin(TFT_CS), rst=Pin(TFT_RST),
