# MicroPython test — 2.79 inch (NV3007)
...
| `main.py` | this folder | The test script for the 2.79 inch |
...
└── narrow-lcd/2.79inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `narrow-lcd/2.79inch/code/micropython/main.py`
