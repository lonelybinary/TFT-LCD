# MicroPython test — 1.9 inch (ST7789)
...
| `main.py` | this folder | The test script for the 1.9 inch |
...
└── narrow-lcd/1.9inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `narrow-lcd/1.9inch/code/micropython/main.py`
