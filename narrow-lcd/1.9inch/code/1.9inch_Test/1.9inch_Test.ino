...
// this one is 170x320 as wired, which is only 170 pixels across - too narrow for
// most text. Rotation 1 turns it on its side and gives us 320x170. The wider
...
Arduino_ST7789 *gfx = new Arduino_ST7789(bus, TFT_RST, 1 /* rotation */, true /* IPS */, 170 /* width */, 320 /* height */,
...
void setup() {
  ...
  Serial.println("Display Size: 1.9 inch");
  Serial.println("Resolution: 170x320 (320x170 landscape)");
  Serial.println("----------------------------------------");
...
void showInfo() {
  ...
  gfx->setTextColor(WHITE);
  gfx->setCursor(4, y); gfx->print("1.9in ST7789"); y += lineH;
