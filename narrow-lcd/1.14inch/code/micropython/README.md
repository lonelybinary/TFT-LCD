# MicroPython test — 1.14 inch (ST7789)
...
| `main.py` | this folder | The test script for the 1.14 inch |
...
└── narrow-lcd/1.14inch/code/micropython/
    └── main.py                   <- and this
```
...
3. In the top pane navigate to the repository, right-click each file → **Upload to /**:
   ...
   - `narrow-lcd/1.14inch/code/micropython/main.py`
...
- **Driver IC:** ST7789 (uses the `st77xx.py` driver)
