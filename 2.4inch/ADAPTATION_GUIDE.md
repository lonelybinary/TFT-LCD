# 2.4-inch Display Adaptation Guide

This guide provides detailed instructions on how to adapt 3.5-inch tutorial code to the 2.4-inch display.

## Display Specifications

| Parameter | Value | Description |
|-----------|-------|-------------|
| **Display Size** | 2.4 inch | Medium size display |
...
**Note**: 2.4-inch has the same resolution as 2.0-inch, adaptation method is the same.

### 2. Driver IC Difference
- **3.5-inch**: ST7796 (`Arduino_ST7796` class)
- **2.4-inch**: ST7789 (`Arduino_ST7789` class)

### 3. Backlight Control
- 2.4-inch is the same as 3.5-inch, using PWM normal control
...
**Note**: 2.4-inch backlight control is exactly the same as 3.5-inch.
...
| 3.5-inch Dimensions | 2.4-inch Dimensions | Calculation Process |
|---------------------|---------------------|---------------------|
...
| 3.5-inch Text Size | 2.4-inch Recommended Size | Notes |
|---------------------|-------------------------|-------|
...
- Example: "Hello World" (12 characters)
  - size 3: 12 × 3 × 6 = 216 pixels (fits 2.4-inch width 240)
  - size 2: 12 × 2 × 6 = 144 pixels (fits 2.4-inch width 240)
  - size 1: 12 × 1 × 6 = 72 pixels (fits 2.4-inch width 240)
...
// 2.4-inch multi-line text (adjusted proportionally)
...
// Usage
int x = convertX(50);  // 3.5-inch's 50 → 2.4-inch's 38
int y = convertY(200); // 3.5-inch's 200 → 2.4-inch's 133
```
...
**A**: 
- 2.4-inch display size is moderate, can display richer UI
- Recommendations:
...
**Tip**: 2.4-inch display adaptation is the same as 2.0-inch, mainly modify driver class and resolution, convert coordinates proportionally.
